...
from src.device_types.schemas import (
    SDeviceTypeRead, SDeviceTypeCreate, SDeviceTypeUpdate
)
...
@router.get(
    ...
    summary="Список своих типов устройств"
)
